...
using (var _context = new AppDbContext())
{
    ...
    #region before the configuration (EFCore normal behaviours and asnotracking, state and first... )
    ////var products = await _context.Products.AsNoTracking().ToListAsync();

    //_context.Products.Add(new() { Name = "kalem 1111", Price = 2000, Stock = 90, Barcode = 567 });
    //_context.Products.Add(new() { Name = "kalem 1111", Price = 2000, Stock = 90, Barcode = 567 });
    //_context.Products.Add(new() { Name = "kalem 1111", Price = 2000, Stock = 90, Barcode = 567 });


    //Console.WriteLine($"Context : {_context.ContextId}");
